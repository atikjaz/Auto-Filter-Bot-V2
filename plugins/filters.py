    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("⭕️ JOIN OUR MAIN CHANNEL ⭕️", url="https://t.me/joinchat/Rd-vhn-rqXhDVMIY")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("⭕️ HOLLYWOOD MOVIE COLLECTION ⭕️", url="https://t.me/Latest_Hollywood_Released_Movies")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("SOURCE CODE", url="https://github.com/atikjaz/Auto-Filter-Bot-V2")]
            ])
